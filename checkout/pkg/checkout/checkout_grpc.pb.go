...
type CheckoutClient interface {
	AddToCart(ctx context.Context, in *AddToCartRequest, opts ...grpc.CallOption) (*empty.Empty, error)
...
func (c *checkoutClient) AddToCart(ctx context.Context, in *AddToCartRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
...
func (c *checkoutClient) DeleteFromCart(ctx context.Context, in *DeleteFromCartRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
...
type CheckoutServer interface {
	AddToCart(context.Context, *AddToCartRequest) (*empty.Empty, error)
...
func (UnimplementedCheckoutServer) AddToCart(context.Context, *AddToCartRequest) (*empty.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method AddToCart not implemented")
}
func (UnimplementedCheckoutServer) DeleteFromCart(context.Context, *DeleteFromCartRequest) (*empty.Empty, error) {
