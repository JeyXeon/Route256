...
// TaskResult содержит результат выполнения таски или ошибку, полученную во время выполнения
type TaskResult[Out any] struct {
	Result Out
	Error  error
}

// Task содержит колбэк, возвращающий результат и ошибку, и аргументы для этого колбека
// Не супер удобная реализация, зато дженерно
