...
func (x *OrderStatusChange) GetId() int64 {
	if x != nil {
		return x.Id
	}
	return 0
...
var file_notifications_proto_rawDesc = []byte{
	...
	0x69, 0x6f, 0x6e, 0x73, 0x22, 0x3b, 0x0a, 0x11, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x53, 0x74, 0x61,
	...
	0x73, 0x42, 0x26, 0x5a, 0x24, 0x72, 0x6f, 0x75, 0x74, 0x65, 0x32, 0x35, 0x36, 0x2f, 0x6e, 0x6f,
...
var file_notifications_proto_goTypes = []interface{}{
	(*OrderStatusChange)(nil), // 0: notifications.OrderStatusChange
}
