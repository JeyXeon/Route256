...
type LomsClient interface {
	...
	OrderPayed(ctx context.Context, in *OrderPayedRequest, opts ...grpc.CallOption) (*empty.Empty, error)
...
func (c *lomsClient) OrderPayed(ctx context.Context, in *OrderPayedRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
...
func (c *lomsClient) CancelOrder(ctx context.Context, in *CancelOrderRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
...
type LomsServer interface {
	...
	OrderPayed(context.Context, *OrderPayedRequest) (*empty.Empty, error)
...
func (UnimplementedLomsServer) OrderPayed(context.Context, *OrderPayedRequest) (*empty.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method OrderPayed not implemented")
}
func (UnimplementedLomsServer) CancelOrder(context.Context, *CancelOrderRequest) (*empty.Empty, error) {
